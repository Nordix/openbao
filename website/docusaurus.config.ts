  ...
  themeConfig: {
    ...
    footer: {
      copyright: [
        ...
        `  <img src="/img/openssf-horizontal-black.svg" class="theme-asset--light" alt="OpenSSF Logo" width="90px" style="vertical-align: middle">`,
        `  <img src="/img/openssf-horizontal-white.svg" class="theme-asset--dark" alt="OpenSSF Logo" width="90px" style="vertical-align: middle">`,
        `</a>`,
